    ...
    <nav class="fixed top-0 right-0 left-0 z-50 flex flex-col border-b border-border/50 bg-white/90 backdrop-blur-lg">
      ...
      <div class="mx-auto flex h-24 w-full max-w-7xl items-center justify-between px-4 lg:px-8">
        ...
        <div class="hidden items-center gap-3 md:flex">
          ...
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" class="relative block group">
            <Button look="primary" size="md" class="relative z-10 gap-2 rounded-full bg-secondary px-6 text-base hover:bg-secondary/90">
            ...
            <span class="absolute inset-0 z-0 animate-ping rounded-full bg-secondary opacity-40 group-hover:opacity-60" />
          </a>
        </div>
      ...
      {isOpen.value && (
        <div class="animate-in fade-in slide-in-from-top-2 border-t border-border/50 bg-white px-4 pb-4 md:hidden">
          ...
          <div class="mt-3 flex flex-col gap-2 border-t border-border/50 pt-3">
            ...
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" class="relative block group">
              <Button look="primary" size="sm" class="relative z-10 w-full gap-2 rounded-full bg-secondary hover:bg-secondary/90">
